...
sub configureDataSource()
    ...
    { title: m.global.localization.predictionsSubmit, itemComponent: "SubmitTextItemComponent" },
    { imageName: "down", itemComponent: "ArrowItemComponent", "newSection" : true},
    { title: m.global.localization.predictionsBack, itemComponent: "SubmitTextItemComponent" }]
...
sub didSelecetItem(event)
    ...
    if isSelectOnArrow
        ...
        if item.title = m.global.localization.predictionsBack
